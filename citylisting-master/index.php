...
while($row = mysqli_fetch_assoc($result))
{
  ?>
  <div class="col-md-3">
  <a href="aficher.php?id=<?php echo ($row['id_ville']); ?>&Nm=<?php echo 1?>" class="card">
      <img class="card-img-top" src="./img/Ifrane-Neige.jpg" alt="Card image cap">
      <div class="card-body">
